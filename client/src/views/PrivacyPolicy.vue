<template>
  <b-card>
    ...
    <p>Welcome to <b> Classroom Bulk Reuse</b>.</p>
    <p>
      <b>Classroom Bulk Reuse</b> (“us”, “we”, or “our”) operates
      <b>cbr.rubhiauliatirta.com</b> (hereinafter referred to as
      <b>“Service”</b>).
    </p>
    <p>
      Our Privacy Policy governs your visit to <b>cbr.rubhiauliatirta.com</b>,
    ...
    <p>
      <b>SERVICE</b> means the cbr.rubhiauliatirta.com website operated by
    ...
    <p>Classroom Bulk Reuse uses the collected data for various purposes:</p>
    ...
    <p>
      Classroom Bulk Reuse will take all the steps reasonably necessary to
    ...
    <p>
      ...
      <b>rubhiauliatirtacom@gmail.com</b>.
    </p>
    <p>
    ...
    <p>
      ...
      send your request(s) by email: <b>rubhiauliatirtacom@gmail.com</b>.
    </p>
    <p>
    ...
    <p>
      ...
      email: <b>rubhiauliatirtacom@gmail.com</b>.
    </p>
    <p style="margin-top: 5em; font-size: 0.7em">
      This
      <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a> was
      created for <b>cbr.rubhiauliatirta.com</b> by
      <a href="https://policymaker.io">PolicyMaker.io</a> on 2021-06-01.
    </p>
  </b-card>
</template>